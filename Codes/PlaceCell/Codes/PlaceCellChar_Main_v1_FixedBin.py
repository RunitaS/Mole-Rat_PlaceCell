...
output_excel = r'C:/Runita/NMR/analysis/AllSort_Results/PlaceCell/Data/PlaceCell_True_v2/Fa1059/Test_FixedBin.xlsx'
...
Output_PlaceTrue = r'C:/Runita/NMR/analysis/AllSort_Results/PlaceCell/Data/PlaceCell_True_v2/Fa1059_FixedBin'
fps            = 30           # tracking frame rate (Hz)
target_bin_cm  = 2.0          # bin size in cm
...
def _plot_and_save_ratemap(fr_map: np.ndarray, valid_mask: np.ndarray,
    ...
    fixed-bin, triangular-smoothed firing-rate map for one cell, and save both
