...
MAX_WORKERS      = 4
"""
! Fix field peak_fr_raw assignment error. Some fields have 0 peak bin fr.
...
# output_excel = r'X:\NMR_group_data\Runita\Analysis\Thesis\Data_v2\All_TT_PlaceChar.xlsx'
...
# Output_PlaceTrue = r'X:\NMR_group_data\Runita\Analysis\Thesis\Data_v2\All_TT_PlaceTrue'
...
min_occ_s      = 0.1            # exclude bins with < 0.1 s occupancy
MAX_GAP_US     = 50_000       # max spike–position gap in µs (50 ms)
N_BOOTSTRAP    = 1000         # circular-shift shuffles for SIR significance
