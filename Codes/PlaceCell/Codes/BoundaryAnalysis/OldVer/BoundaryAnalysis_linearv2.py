...
root_folder  = r'C:/Runita/NMR/analysis/TAC6/Data/Linear'
output_excel = r'C:/Runita/NMR/analysis/TAC6/Data/Linear/Linear_BoundaryAnalysis.xlsx'
...
def compute_metrics(csv_path: str, ntt_path: str,
    ...
    ctx = dict(spike_ts=spike_ts[valid_spike], spike_frame=spike_frame, t=t,
               ...
               max_x_cm=float(x_cm.max()), max_y_cm=float(y_cm.max()))
