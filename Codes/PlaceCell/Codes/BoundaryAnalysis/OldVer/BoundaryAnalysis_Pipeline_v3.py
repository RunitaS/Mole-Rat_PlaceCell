...
def classify_edge_centre(
    ...
    Circular track (annular ring):
      ...
      - A bin is 'edge' when it is nearer the outer wall than the inner wall, and
        'centre' when it is nearer the inner wall. Since the ring is normally only
        2 bins wide radially, this cleanly separates the outer-wall-touching ring
        of bins (edge) from the inner-wall-touching ring of bins (centre).
