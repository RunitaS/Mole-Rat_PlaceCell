...
ROOT_DIRECTORY = r'X:\NMR_group_data\Runita\Analysis\Thesis\Data_v2_Accepted\SessionType_Sorted\Open\Rotate'

# Output folder for all figures / workbooks (same location as before, now derived from the root).
OUTPUT_DIR = os.path.join(ROOT_DIRECTORY, 'MeanRM_Quad_Rayleigh_mN')
...
ROTATE_SESSION_CCW_DEG  = 120.0 #120.0
