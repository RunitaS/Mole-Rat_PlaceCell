function [ret,beta,f0,in]=speed_firing(posx,posy,posts,ts,PosSampleRate)
...
InstSpeed = speed;
Alltime = posts; %[0:1000/30:posts(end)];
% Alltime2 = [0:1000/25:posts(end)];
[FirRate,x]= histc(ts,Alltime);
FirRate = FirRate* PosSampleRate;

Speedsmoothingwindows = 0.2;
