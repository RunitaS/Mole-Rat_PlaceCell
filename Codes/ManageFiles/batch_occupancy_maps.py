...
# ── USER INPUT ──────────────────────────────────────────────────────────────
ROOT_DIR = r'C:/Runita/NMR/analysis/TrackingCorrection/Open'  # root folder to search recursively
OUTPUT_DIR = r'C:/Runita/NMR/analysis/TrackingCorrection/v1_Corr/Open'  # all .png maps are saved here (flat, not mirrored)
