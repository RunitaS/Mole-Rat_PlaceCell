...
# ── USER INPUT ──────────────────────────────────────────────────────────────
ROOT_DIR = r'C:/Runita/NMR/analysis/TrackingCorrection'  # root folder to search recursively
OUTPUT_DIR = r'C:/Runita/NMR/analysis/TrackingCorrection/v0_noCorr'  # all .png maps are saved here (flat, not mirrored)
