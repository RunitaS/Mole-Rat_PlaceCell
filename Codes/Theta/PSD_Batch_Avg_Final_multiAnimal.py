...
OUTPUT_DIR = r'C:/Runita/NMR/analysis/SurgeryPaperSpikeLFP/LFP/Figs/trash'  # saved plots go here
...
STYLES = {
    ...
    'FaDDE42': ('#E41A1C', '#EA6F6F'),  # red
    #'Fa23BD': ('#4DAF4A', '#8DD39E'),   # green
}
...
ax.set_ylim(max(y_min_global * 0.8, 1e-6), y_max_global * 1.5)
