...
# animal's ID (e.g. ROOT_DIR/Fa8477/...).
...
# Which animals (by ID / subfolder name under ROOT_DIR) to include in this
# analysis. Comment/remove an ID here to exclude it -- e.g. to drop Fa5834's
# LFP from FOOOF analysis, delete or comment its line below. ANIMALS,
# STYLES, and everything downstream are derived automatically from this list.
ANIMALS_TO_INCLUDE = [
    'Fa1059',
    'Fa23BD',
    # 'Fa5834',
...
# Plot colors, filenames, and legends below are all derived automatically
# from this dict's keys.
ANIMALS = {
...
if __name__ == '__main__':
    ...
    # 5) Theta-range summary (per animal + grand average) and box plot.
