...
FBOSCPY_DIR = r'F:/Temp/Theta/fBOSC_Res/v8_90Percentile'
...
OUTPUT_DIR = r'F:/Temp/Theta/fBOSC_Res/v8_90Percentile'  # saved plots go here
...
FBOSC_F_ARRAY      = np.arange(FREQ_RANGE_LOW, FBOSC_REGION_F_MAX + FBOSC_F_BUFFER_HZ + 0.5, 1.0)
