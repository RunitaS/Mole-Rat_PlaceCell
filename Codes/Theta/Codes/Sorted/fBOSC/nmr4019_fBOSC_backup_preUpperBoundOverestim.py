...
FBOSCPY_DIR = r'F:/Temp/Theta/fBOSC_Res/v3_fBOSC1-100Hz'
...
OUTPUT_DIR = r'F:/Temp/Theta/fBOSC_Res/v3_fBOSC1-100Hz'  # saved plots go here
...
FBOSC_F_ARRAY      = np.arange(1, 100, 1.0)  # Hz; frequencies scanned for oscillations (restricted to
                                               # 1-20 Hz -- above this, line-noise harmonics (50/100/150/200 Hz,
                                               # see LINE_HARMONICS) corrupt the background fit and theta detection)
