...
Theta power vs. depth (DeptProfile_v4.py:679-683): computed from scan_recording, 
which bins the entire recording into 1 s windows (NOISE_BIN_S), excludes noisy bins, 
and averages theta power across all remaining clean bins. This isn't snippet-based 
at all — it uses the whole recording.

Theta phase/lag vs. depth (DeptProfile_v4.py:583-655): compute_phase_profile loops 
